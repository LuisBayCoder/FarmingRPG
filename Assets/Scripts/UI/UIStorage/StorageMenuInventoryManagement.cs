...
public class StorageMenuInventoryManagement : MonoBehaviour
{

    [SerializeField] private StorageMenuInventoryManagementSlot[] inventoryManagementSlot = null;
    ...
    {
        EventHandler.InventoryUpdatedEvent += PopulateStorageInventory;
        ...
        {
            Debug.Log("StorageMenuInventoryManagement StorageInventoryManager.Instance is null");
        }
    }
