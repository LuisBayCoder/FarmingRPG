...
public class StoreInventoryManager : SingletonMonobehaviour<StoreInventoryManager>, ISaveable
{
    ...
    public void AddItem(InventoryLocation location, InventoryItem item)
    {
        ...
        if (inventoryLists[locationIndex] == null)
        {
            inventoryLists[locationIndex] = new List<InventoryItem>();
        }
